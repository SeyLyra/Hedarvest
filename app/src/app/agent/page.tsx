...
// API base URL
const API_BASE_URL = typeof window !== 'undefined' ? (window as any).location?.origin || 'http://localhost:3000' : 'http://localhost:3000';
...
export default function AgentPage() {
        ...
        <div className="relative z-10 min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-md w-full space-y-8">
            <div className="text-center">
              ...
              <h2 className="text-4xl font-bold bg-gradient-to-r from-emerald-800 via-emerald-700 to-teal-800 bg-clip-text text-transparent mb-2">
                {authMode === 'login' ? 'Agent Portal' : 'Join as Agent'}
              </h2>
              <p className="text-lg text-emerald-600 font-medium">
                {authMode === 'login' 
                  ? 'Welcome back to your agent dashboard' 
                  : 'Transform agriculture through DeFi innovation'
                }
              </p>
            </div>
          
          <Card className="bg-white/80 backdrop-blur-3xl border-white/30 shadow-2xl">
            <CardHeader className="pb-4">
              <CardTitle className="flex items-center text-2xl font-bold bg-gradient-to-r from-emerald-800 to-teal-800 bg-clip-text text-transparent">
                {authMode === 'login' ? (
                  <>
            ...
            <CardContent className="space-y-6">
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      <Mail className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5 text-emerald-500 group-focus-within:text-emerald-600 transition-colors" />
                      <Input
                        type="email"
                        value={loginForm.email}
                        onChange={(e) => setLoginForm(prev => ({ ...prev, email: e.target.value }))}
                        placeholder="Enter your email"
                        className="pl-12 h-12 bg-emerald-50/50 border-emerald-200 focus:border-emerald-400 focus:ring-emerald-400/20 rounded-xl transition-all duration-300"
                        required
                      />
                    </div>
                  </div>
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      <Lock className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5 text-emerald-500 group-focus-within:text-emerald-600 transition-colors" />
                      <Input
                        type="password"
                  ...
                  <Button
                    ...
                    className="w-full h-12 bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 hover:from-emerald-400 hover:via-teal-400 hover:to-cyan-400 text-white font-bold rounded-xl shadow-lg hover:shadow-emerald-500/25 transition-all duration-300 hover:scale-105"
                  >
              ...
              <form onSubmit={handleRegisterAgent} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    <User className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5 text-emerald-500 group-focus-within:text-emerald-600 transition-colors" />
                    <Input
                      type="text"
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="h-12 bg-emerald-50/50 border-emerald-200 focus:border-emerald-400 focus:ring-emerald-400/20 rounded-xl transition-all duration-300"
                    required
                  />
                </div>
                <div className="space-y-2">
                ...
                <Button
                  ...
                  className="w-full h-12 bg-gradient-to-r from-amber-500 via-orange-500 to-red-500 hover:from-amber-400 hover:via-orange-400 hover:to-red-400 text-white font-bold rounded-xl shadow-lg hover:shadow-orange-500/25 transition-all duration-300 hover:scale-105"
                >
                ...
                {authMode === 'login' ? (
                  <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl p-4 border border-emerald-200">
                    <p className="text-sm text-emerald-700 mb-3">
                      New to Hedarvest Agent Network?
                    </p>
                    <button
                      onClick={() => setAuthMode('register')}
                      className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-white font-semibold rounded-xl shadow-lg hover:shadow-emerald-500/25 transition-all duration-300 hover:scale-105"
                    >
                  ...
                  <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl p-4 border border-amber-200">
                    ...
                    <button
                      ...
                      className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-white font-semibold rounded-xl shadow-lg hover:shadow-amber-500/25 transition-all duration-300 hover:scale-105"
                    >
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      {/* Header */}
      <header className="relative z-50 w-full bg-gradient-to-r from-white/95 via-white/90 to-white/85 backdrop-blur-3xl border-b border-white/30 shadow-2xl sticky top-0">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3 group cursor-pointer">
              ...
              <div>
                ...
                <div className="text-xs text-emerald-600 font-medium">Agent Portal</div>
              </div>
            </div>
            
            {/* Agent Info */}
            <div className="flex items-center space-x-4">
              <div className="bg-gradient-to-r from-emerald-50/90 to-teal-50/90 border border-emerald-200/50 rounded-xl px-4 py-2 backdrop-blur-sm">
                <div className="text-right">
                  <p className="text-sm font-semibold text-emerald-800">{agentProfile?.name || 'Loading...'}</p>
              ...
              <Button
                ...
                className="flex items-center bg-gradient-to-r from-red-50 to-pink-50 border-red-200 text-red-700 hover:from-red-100 hover:to-pink-100 hover:border-red-300 transition-all duration-300 hover:scale-105"
              >
                <LogIn className="h-4 w-4 mr-2" />
                Logout
              </Button>
          ...
          <div className="w-64 flex-shrink-0">
            <nav className="space-y-3">
              <button
                ...
                className={`w-full flex items-center px-4 py-4 text-sm font-semibold rounded-xl transition-all duration-300 group ${
                  activeSection === 'dashboard'
                      ? 'bg-gradient-to-r from-emerald-500 to-teal-500 text-white shadow-lg shadow-emerald-500/25'
                      : 'text-emerald-700 hover:text-emerald-800 hover:bg-gradient-to-r hover:from-emerald-50 hover:to-teal-50 hover:shadow-md'
                }`}
              >
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center mr-3 transition-all duration-300 ${
                  ...
                  <Eye className={`h-5 w-5 ${
                    activeSection === 'dashboard' ? 'text-white' : 'text-emerald-600'
                  }`} />
                </div>
                Dashboard
              </button>
              ...
              >
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center mr-3 transition-all duration-300 ${
                  ...
                  <User className={`h-5 w-5 ${
                    activeSection === 'profile' ? 'text-white' : 'text-emerald-600'
                  }`} />
                </div>
                Agent Profile
              </button>
                  ...
                  >
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center mr-3 transition-all duration-300 ${
                      ...
                      <Users className={`h-5 w-5 ${
                        activeSection === 'farmers' ? 'text-white' : 'text-emerald-600'
                      }`} />
                    </div>
                    Farmer Management
                  </button>
                  ...
                  >
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center mr-3 transition-all duration-300 ${
                      ...
                      <Package className={`h-5 w-5 ${
                        activeSection === 'collateral' ? 'text-white' : 'text-emerald-600'
                      }`} />
                    </div>
                  ...
                  >
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center mr-3 transition-all duration-300 ${
                      ...
                      <DollarSign className={`h-5 w-5 ${
                        activeSection === 'loans' ? 'text-white' : 'text-emerald-600'
                      }`} />
                    </div>
                    Loan Management
                  </button>
